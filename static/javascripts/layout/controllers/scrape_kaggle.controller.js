(function () {
  ...
  //   .controller('ScrapeKaggleController', ScrapeKaggleController);

  angular
    .module('djangular.layout.controllers')
    .controller('ScrapeKaggleController', function($scope,$http) {
    
      //console.log($http.get('/api/v1/scrape_kaggle'));
